...
* Tue Aug 30 2011 Honza Horak <hhorak@redhat.com> - 2.19-21
- fixed a resource leak in -strcat patch
  Resolves: #732724

* Fri Aug 12 2011 Honza Horak <hhorak@redhat.com> - 2.19-20
- changed shadow patch to allow different number of columns 
  in passwd.adjunct file than in shadow file
  Resolves: #699667

* Fri Jun 24 2011 Honza Horak <hhorak@redhat.com> - 2.19-19
- Added passwd.adjunct support in yppasswdd to recognize 
  password format correctly when changing password using yppasswd
  Resolves: #699667
- Fix strcat on uninitialized memory in yppasswdd
  Resolves: #699675
